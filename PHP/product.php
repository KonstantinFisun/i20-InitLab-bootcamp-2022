<?php
    ...
    $request = "SELECT url, alt
                ...
                WHERE image_product.product_id = $id_product and product.main_image != image.image_id";
    $query = $db->prepare($request);
    $query->execute();
    ...
    $request = "SELECT title
                ...
                WHERE category_product.product_id = $id_product";
    $query = $db->prepare($request);
    $query->execute();
            ...
            <div class="product__description">
                ...
                <div class="product__counter">
                    ...
                    <div class="product__counter-item">
                        <div class="minus"><ion-icon name="remove-outline"></ion-icon></div>
                        <input class='product__counter-value' type="number" value="1" step="1" min="1" max="100">
                        <div class="plus"><ion-icon name="add-outline"></ion-icon></div>
                    </div>
